<html lang="en">
    ...
    <body>
    <link rel="stylesheet" href="/home/www/www.candidature.pfinancespubliques.orgV1/candidature.pfinancespubliques.org/resources/css/stylepdf.css">
    <style>
		@page {
			margin-top: 0.3em;
			margin-left: 0.9em;
			...
			<table>	
				<tr>
					...
					<div class='header_middle'>
						<img src="/home/www/www.candidature.pfinancespubliques.orgV1/candidature.pfinancespubliques.org/resources/images/logo5.png" style="width: 150px;"/>
					</div>
					</td>					
					<td width='50'>					
					</td>
