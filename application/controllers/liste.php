			...
			$this->table->add_row( ++$i, $candidat->nom . " ". $candidat->prenom, $specialite->nom, strtoupper($candidat->statut_prof), strtoupper($candidat->date_enregistrement), 
				'<div class="btn-group" style="min-width:150px">
                        ...
                        <ul class="dropdown-menu">'.
                                '<li><a href="/index.php/impression/imprimer_fiche/'.$candidat->id.'"><i class="icon-zoom-in"></i> Afficher dossier détaillé</a></li>'.
                                '<li><a href="/index.php/candidature/marquerdeposer/'.$candidat->id.'"><i class="icon-trash"></i> Marquer comme déposé</a></li>'.
