...
class Candidature extends CI_Controller {
    ...
    public function index() {
        ...
        $data["regions"] = $this->model->get_regions(); // Ajout des régions
...
//            $this->form_validation->set_rules('langue', 'langue', 'trim|required');
		...
		$this->form_data->type_etude= $this->input->post('type_etude');
		    ...
		    'telephone2' => $this->input->post('telephone2'),
                    ...
                    'specialite_dernier_diplome' => $this->input->post('specialite_dernier_diplome'),
    'etablissement_obtention' => $this->input->post('etablissement_obtention'),
    'niveau_connaissance_fp' => $this->input->post('niveau_connaissance_fp'),
    'motivation_pssfp' => $this->input->post('motivation_pssfp'),
    'utilite_formation' => $this->input->post('utilite_formation'),
    'domaines_interet_fp' => $this->input->post('domaines_interet_fp'),
